#!/usr/bin/env python 
# -*- coding: utf-8 -*-
# @Time    : 2020/7/27 下午7:03
# @Author  : qijianwei
# @File    : custom_crf_utils.py
# @Usage: 基本结构与tf.contrib.crf.crf_log_likelihood一致，在接口中添加floatx参数，用于执行精度量化
...
def crf_sequence_score(inputs, tag_indices, sequence_lengths,
  ...
  """
    ...
    def _multi_seq_fn():
        ...
        unary_scores = crf_unary_score(tag_indices, sequence_lengths, inputs, floatx)
...
def crf_log_norm(inputs, sequence_lengths, transition_params, floatx):
...
def crf_log_likelihood(inputs,
  ...
  """
    ...
    sequence_scores = crf_sequence_score(inputs, tag_indices, sequence_lengths,
                                         transition_params, floatx)
    log_norm = crf_log_norm(inputs, sequence_lengths, transition_params, floatx)
...
def crf_unary_score(tag_indices, sequence_lengths, inputs, floatx):
...
def crf_binary_score(tag_indices, sequence_lengths, transition_params, floatx):
